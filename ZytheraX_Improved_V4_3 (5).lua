...
task.spawn(function()
    ...
    bg.BackgroundColor3 = Color3.fromRGB(6, 3, 8)
    bg.BorderSizePixel = 0
    bg.Parent = gui
    local bgGrad = Instance.new("UIGradient")
    bgGrad.Color = ColorSequence.new({
        ColorSequenceKeypoint.new(0, Color3.fromRGB(20, 5, 12)),
        ColorSequenceKeypoint.new(0.5, Color3.fromRGB(10, 3, 8)),
        ColorSequenceKeypoint.new(1, Color3.fromRGB(2, 1, 4)),
    })
    bgGrad.Rotation = 90
    bgGrad.Parent = bg
    ...
    glow.Size = UDim2.new(0, 500, 0, 160)
    ...
    emblem.Size = UDim2.new(1, 0, 0, 60)
    emblem.Position = UDim2.new(0, 0, 0, 10)
    ...
    status.TextColor3 = Color3.fromRGB(150, 130, 135)
    status.TextSize = 11
    status.Parent = box
    ...
    barBg.Position = UDim2.new(0.5, -170, 0, 130)
    barBg.BackgroundColor3 = Color3.fromRGB(20, 8, 12)
    ...
    pct.Size = UDim2.new(1, 0, 0, 14)
    pct.Position = UDim2.new(0, 0, 0, 140)
    pct.BackgroundTransparency = 1
    pct.Font = Enum.Font.GothamBold
    pct.Text = "0%"
    pct.TextColor3 = Color3.fromRGB(200, 30, 30)
    pct.TextSize = 12
    ...
    task.spawn(function()
        while gui and gui.Parent do
            glow.ImageTransparency = 0.4 + math.sin(tick() * 2.5) * 0.2
            emblem.TextStrokeTransparency = 0.25 + math.sin(tick() * 2.5) * 0.15
            task.wait(0.03)
        end
    end)
    ...
    local steps = {
        {0.15, "Loading services..."},
        {0.30, "Hooking remotes..."},
        {0.45, "Loading parry system..."},
        {0.60, "Building UI..."},
        {0.75, "Applying theme..."},
        {0.90, "Finalizing..."},
        {1.00, "Ready"},
    ...
    for _, step in ipairs(steps) do
        barFill.Size = UDim2.new(step[1], 0, 1, 0)
        pct.Text = tostring(math.floor(step[1] * 100)) .. "%"
        status.Text = step[2]
        task.wait(0.25)
    end
    ...
    for _, obj in ipairs({bg, emblem, title, status, barFill, barBg, pct, glow}) do
        if obj then
            if obj:IsA("TextLabel") then
                TweenService:Create(obj, fadeInfo, {TextTransparency = 1, TextStrokeTransparency = 1, BackgroundTransparency = 1}):Play()
...
local old_Balls = CoreGui:FindFirstChild('ZytheraX')

if old_Balls then
    Debris:AddItem(old_Balls, 0)
end

if not isfolder("ZytheraX") then
    makefolder("ZytheraX")
end
...
local Config = setmetatable({
    save = function(self, file_name, config)
        local success_save, result = pcall(function()
            ...
            writefile('ZytheraX/'..file_name..'.json', flags)
        end)
    ...
    load = function(self, file_name, config)
        local success_load, result = pcall(function()
            if not isfile('ZytheraX/'..file_name..'.json') then
                self:save(file_name, config)

                return
            end

            local flags = readfile('ZytheraX/'..file_name..'.json')
...
function Library.SendNotification(settings)
    ...
    InnerFrame.BackgroundColor3 = Color3.fromRGB(12, 12, 12)
    ...
    InnerUICorner.CornerRadius = UDim.new(0, 2)
    ...
    Body.TextColor3 = Color3.fromRGB(200, 55, 55)
...
function Library:create_ui()
    ...
    Container.BackgroundColor3 = Color3.fromRGB(10, 8, 12)

    local _bgGrad = Instance.new('UIGradient')
    _bgGrad.Color = ColorSequence.new{
        ColorSequenceKeypoint.new(0, Color3.fromRGB(14, 8, 16)),
        ColorSequenceKeypoint.new(0.5, Color3.fromRGB(10, 6, 12)),
        ColorSequenceKeypoint.new(1, Color3.fromRGB(6, 4, 8))
    }
    _bgGrad.Rotation = 90
    _bgGrad.Parent = Container
    ...
    task.spawn(function()
        ...
        while Container.Parent do
            t = (t + 0.015) % 2
            StrokeGradient.Offset = Vector2.new(t - 1, 0)
            task.wait(0.033)
        end
    end)
    ...
    Handler.BackgroundColor3 = Color3.fromRGB(12, 8, 14)
    ...
    Tabs.BorderColor3 = Color3.fromRGB(12, 12, 12)
    Tabs.BackgroundColor3 = Color3.fromRGB(14, 8, 16)
    ...
    BrandBar.BackgroundTransparency = 1
    BrandBar.Size = UDim2.new(0, 160, 0, 28)
    BrandBar.AnchorPoint = Vector2.new(0, 0.5)
    BrandBar.Position = UDim2.new(0.056, 0, 0.055, 0)
    BrandBar.BorderSizePixel = 0
    BrandBar.Parent = Handler
    ...
    Icon.BackgroundColor3 = Color3.fromRGB(180, 35, 35)
    Icon.BorderSizePixel = 0
    Icon.Parent = BrandBar
    ...
    ClientName.Text = 'Zythera-X'
    ClientName.Name = 'ClientName'
    ClientName.Size = UDim2.new(0, 120, 0, 28)
    ClientName.AnchorPoint = Vector2.new(0, 0.5)
    ClientName.Position = UDim2.new(0, 34, 0.5, 0)
    ClientName.BackgroundTransparency = 1
    ClientName.TextXAlignment = Enum.TextXAlignment.Left
    ClientName.BorderSizePixel = 0
    ClientName.TextSize = 15
    ClientName.Parent = BrandBar
    ...
    task.spawn(function()
        ...
        BrandBar.Position = UDim2.new(0.056, -40, 0.055, 0)
        ClientName.TextTransparency = 1
        Icon.BackgroundTransparency = 1
        Icon.TextTransparency = 1
        TweenService:Create(BrandBar, TweenInfo.new(0.6, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
            Position = UDim2.new(0.056, 0, 0.055, 0)
        }):Play()
        TweenService:Create(ClientName, TweenInfo.new(0.5, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
            TextTransparency = 0
        }):Play()
        ...
        local t = 0
        while BrandBar.Parent do
            t = t + 0.04

            local shimmer = (math.sin(t) + 1) / 2
            UIGradient.Offset = Vector2.new(-1 + (shimmer * 2), 0)

            local pulse = (math.sin(t * 1.3) + 1) / 2
            IconStroke.Transparency = 0.45 - (pulse * 0.4)
            IconStroke.Thickness = 1 + (pulse * 1.2)
    ...
    Pin.BackgroundColor3 = Color3.fromRGB(220, 40, 40)
    Pin.Parent = Handler
    ...
    Divider.BorderColor3 = Color3.fromRGB(12, 12, 12)
    Divider.Size = UDim2.new(0, 1, 0, 479)
    Divider.BorderSizePixel = 0
    Divider.BackgroundColor3 = Color3.fromRGB(12, 12, 12)
    ...
    Minimize.TextColor3 = Color3.fromRGB(12, 12, 12)
    Minimize.BorderColor3 = Color3.fromRGB(12, 12, 12)
    Minimize.Text = ''
    ...
    function self:change_visiblity(state)
        if state then
            ...
            if Handler:FindFirstChild('BrandBar') then
                ...
                if bb:FindFirstChild('Icon') then
                    TweenService:Create(bb.Icon, TweenInfo.new(0.3, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
            ...
            if object == tab then
                if object.BackgroundTransparency ~= 0.5 then
                    ...
                    TweenService:Create(object.TextLabel, TweenInfo.new(0.5, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
                        ...
                        TextColor3 = Color3.fromRGB(200, 55, 55)
                    }):Play()
    ...
    function self:create_tab(title, icon)
        ...
        Tab.BorderColor3 = Color3.fromRGB(12, 12, 12)
        Tab.Text = ''
        ...
        TextLabel.BorderColor3 = Color3.fromRGB(12, 12, 12)
        ...
        UIGradient.Color = ColorSequence.new{
            ...
            ColorSequenceKeypoint.new(0.7, Color3.fromRGB(140, 25, 25)),
        ...
        Icon.BorderColor3 = Color3.fromRGB(12, 12, 12)
        Icon.AnchorPoint = Vector2.new(0, 0.5)
        Icon.BackgroundTransparency = 1
        ...
        LeftSection.BorderColor3 = Color3.fromRGB(12, 12, 12)
        ...
        RightSection.BorderColor3 = Color3.fromRGB(12, 12, 12)
        ...
        function TabManager:create_module(settings)
            ...
            Module.BorderColor3 = Color3.fromRGB(12, 12, 12)
            Module.BackgroundTransparency = 0.5
            Module.Position = UDim2.new(0.004115226212888956, 0, 0, 0)
            Module.Name = 'Module'
            Module.Size = UDim2.new(0, 241, 0, 93)
            Module.BorderSizePixel = 0
            Module.BackgroundColor3 = Color3.fromRGB(12, 12, 12)
            ...
            local UIStroke = Instance.new('UIStroke')
            UIStroke.Color = Color3.fromRGB(45, 10, 10)
            ...
            Header.TextColor3 = Color3.fromRGB(12, 12, 12)
            Header.BorderColor3 = Color3.fromRGB(12, 12, 12)
            Header.Text = ''
            ...
            ModuleName.TextColor3 = Color3.fromRGB(200, 55, 55)
            ...
            ModuleName.BorderColor3 = Color3.fromRGB(12, 12, 12)
            ModuleName.TextSize = 13
            ModuleName.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
            ModuleName.Parent = Header

            local Description = Instance.new('TextLabel')
            Description.FontFace = Font.new('rbxasset://fonts/families/GothamSSm.json', Enum.FontWeight.SemiBold, Enum.FontStyle.Normal)
            Description.TextColor3 = Color3.fromRGB(200, 55, 55)
            ...
            Description.BorderColor3 = Color3.fromRGB(12, 12, 12)
            ...
            Circle.BorderColor3 = Color3.fromRGB(12, 12, 12)
            ...
            Keybind.BorderColor3 = Color3.fromRGB(12, 12, 12)
            Keybind.Size = UDim2.new(0, 33, 0, 15)
            Keybind.BorderSizePixel = 0
            Keybind.BackgroundColor3 = Color3.fromRGB(180, 35, 35)
            ...
            Options.BorderColor3 = Color3.fromRGB(12, 12, 12)
            ...
            if Library:flag_type(settings.flag, 'boolean') then
                ...
                Toggle.BackgroundColor3 = Color3.fromRGB(180, 35, 35)
                Circle.BackgroundColor3 = Color3.fromRGB(180, 35, 35)
            ...
            function ModuleManager:create_textbox(settings)
                ...
                Textbox.BorderColor3 = Color3.fromRGB(12, 12, 12)
                ...
                Textbox.TextSize = 10
                Textbox.BackgroundColor3 = Color3.fromRGB(180, 35, 35)
            ...
            function ModuleManager:create_checkbox(settings)
                ...
                Checkbox.TextColor3 = Color3.fromRGB(12, 12, 12)
                Checkbox.BorderColor3 = Color3.fromRGB(12, 12, 12)
                Checkbox.Text = ""
                ...
                KeybindBox.BackgroundColor3 = Color3.fromRGB(180, 35, 35)
                ...
                KeybindLabel.TextColor3 = Color3.fromRGB(12, 12, 12)
                ...
                local Box = Instance.new("Frame")
                Box.BorderColor3 = Color3.fromRGB(12, 12, 12)
                ...
                Box.BackgroundColor3 = Color3.fromRGB(180, 35, 35)
                Box.Parent = Checkbox
                ...
                Fill.BorderColor3 = Color3.fromRGB(12, 12, 12)
                Fill.Name = "Fill"
                Fill.BorderSizePixel = 0
                Fill.BackgroundColor3 = Color3.fromRGB(180, 35, 35)
                Fill.Parent = Box
            ...
            function ModuleManager:create_slider(settings)
                ...
                Slider.TextSize = 14;
                Slider.TextColor3 = Color3.fromRGB(12, 12, 12)
                Slider.BorderColor3 = Color3.fromRGB(12, 12, 12)
                Slider.Text = ''
                ...
                Drag.BorderColor3 = Color3.fromRGB(12, 12, 12)
                ...
                Drag.BackgroundColor3 = Color3.fromRGB(180, 35, 35)
                Drag.Parent = Slider
                ...
                Value.BorderColor3 = Color3.fromRGB(12, 12, 12)
                Value.TextSize = 10
            ...
            function ModuleManager:create_dropdown(settings)
                ...
                Dropdown.TextColor3 = Color3.fromRGB(12, 12, 12)
                Dropdown.BorderColor3 = Color3.fromRGB(12, 12, 12)
                Dropdown.Text = ''
                ...
                CurrentOption.TextColor3 = Color3.fromRGB(240, 240, 240)
                ...
                CurrentOption.BorderColor3 = Color3.fromRGB(12, 12, 12)
                CurrentOption.TextSize = 10
                CurrentOption.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
                ...
                Arrow.BorderColor3 = Color3.fromRGB(12, 12, 12)
                ...
                Arrow.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
                Arrow.Parent = Header

                local Options = Instance.new('ScrollingFrame')
                Options.ScrollBarImageColor3 = Color3.fromRGB(12, 12, 12)
                Options.Active = true
                ...
                if #settings.options > 0 then
                    ...
                    for index, value in settings.options do
                        ...
                        Option.BorderColor3 = Color3.fromRGB(12, 12, 12)
            ...
            function ModuleManager:create_feature(settings)
                ...
                FeatureButton.BackgroundColor3 = Color3.fromRGB(12, 12, 12)
                FeatureButton.TextColor3 = Color3.fromRGB(240, 240, 240)
                ...
                UIStroke.Color = Color3.fromRGB(180, 35, 35)
                UIStroke.Thickness = 1
                UIStroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
                ...
                if not settings.disablecheck then
                    ...
                    Checkbox.BackgroundColor3 = checked and Color3.fromRGB(180, 35, 35) or Color3.fromRGB(12, 12, 12)
                    Checkbox.Text = ""
...
local ParryRawFunc = nil
local ParryArgs = {nil,nil,nil,nil,nil,nil,nil}
...
if hookfn and newcc then
    pcall(function()
        ...
        origFireServer = hookfn(dummyEvent.FireServer, newcc(function(self, ...)
            local args = {...}
            if isValidRemoteArgs(args) then
                if not remoteHooked then
                    remoteHooked = true
                    ParryRemote = self
                    ParryRawFunc = origFireServer
                    for i = 1, 7 do ParryArgs[i] = args[i] end
                else
                    for i = 1, 7 do ParryArgs[i] = args[i] end
                end
            end
        ...
        origInvokeServer = hookfn(dummyFunc.InvokeServer, newcc(function(self, ...)
            local args = {...}
            if isValidRemoteArgs(args) then
                if not remoteHooked then
                    remoteHooked = true
                    ParryRemote = self
                    ParryRawFunc = origInvokeServer
                    for i = 1, 7 do ParryArgs[i] = args[i] end
                else
                    for i = 1, 7 do ParryArgs[i] = args[i] end
                end
        ...
        mt.__index = newcclosure(function(self, key)
            if key == "FireServer" or key == "InvokeServer" then
                return function(instance, ...)
                    ...
                    if isValidRemoteArgs(args) then
                        remoteHooked = true
                        ParryRemote = instance
                        ParryRawFunc = oldIdx(instance, "FireServer")
                        for i = 1, 7 do ParryArgs[i] = args[i] end
                    end
                    return oldIdx(self, key)(instance, ...)
                end
            end
...
task.spawn(function()
    while not remoteHooked do task.wait(0.05) end
    Library.SendNotification({
        title = "Remote Hooked",
        text = getgenv()._hookUsedStr or "OK",
        duration = 5,
    })
end)
...
function Auto_Parry.Parry(Parry_Type)
    ...
    if not (ParryRemote and ParryRawFunc) then
        return false
    end
    lastParryTime = tick()
    ...
    for i = 1, presses do
        ParryArgs[1] = ParryArgs[1]
        ParryArgs[2] = ParryArgs[2]
        ParryArgs[3] = parryData[2].LookVector
        ParryArgs[4] = parryData[2]
        ParryArgs[5] = parryData[3]
        ParryArgs[6] = parryData[4]
        local ok, err = pcall(function()
            ParryRawFunc(ParryRemote, unpack(ParryArgs))
        end)
        if not ok then
...
do
        ...
        module:create_checkbox({
                title = "Remote Status",
                flag = "Remote_Status_Check",
                callback = function(value)
                        if value then
                                Library.SendNotification({
                                        title = "Remote Status",
                                        text = remoteHooked and ("Hooked — " .. (getgenv()._hookUsedStr or "OK")) or "Not hooked yet",
                                        duration = 5,
                                })
                        end
                end,
...
if PlayerGui:FindFirstChild("Zythera-X") then
    PlayerGui["Zythera-X"]:Destroy()
end
...
local BallsGui = CoreGui:WaitForChild("ZytheraX", 60)

if not BallsGui then
    warn("Could not find the 'ZytheraX' GUI. The original script may have failed to load.")
    return
end
...
local THEME = {
    ...
    STROKE = Color3.fromRGB(180, 35, 35)
}
